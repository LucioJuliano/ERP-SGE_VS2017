    ...
    public partial class FrmLogin : Form
    {
        ...
        private void PopularConexao()
        {
            ...
            if (FrmPrincipal.VersaoDistribuidor)
                FrmPrincipal.StringConexao = "Data Source=" + Linha[0]["Conexao"].ToString() + "; Initial Catalog=BD_ERP_SGE; User ID=Distribuidor; Password=systalimpo; MultipleActiveResultSets=True;";
            else
                FrmPrincipal.StringConexao = "Data Source=" + Linha[0]["Conexao"].ToString() + "; Initial Catalog=BD_ERP_SGE; User ID=talimpo; Password=systalimpo; MultipleActiveResultSets=True;";
