<%@ Page Language="C#" MasterPageFile="~/VendasNET.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" Title="Acesso ao Sistema" %>
                           ...
                           <tr>
                               ...
                               <td>
                                   <asp:TextBox ID="UserName" runat="server" BackColor="Gainsboro" 
                                       ...
                                       ForeColor="Black" Height="20px" Width="150px" style="text-transform:uppercase"></asp:TextBox>
