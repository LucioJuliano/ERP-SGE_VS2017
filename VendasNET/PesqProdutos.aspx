<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesqProdutos.aspx.cs" Inherits="PesqProdutos" %>
      ...
      <table id="Table1" runat="server" style="width: 100%;"> 
       <tr >    
         <td>
             ...
             <asp:TextBox ID="TxtDescricao" runat="server" Font-Size="8pt" Width="350px"></asp:TextBox>
         ...
         <td>
           <div>
             <asp:GridView ID="GridDados" runat="server" AutoGenerateColumns="False" 
                   ...
                   Font-Underline="False" Width="639px" 
