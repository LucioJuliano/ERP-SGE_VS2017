...
namespace Controles
{
    class ElginEcoPos
    {
        ...
        public void initializePrinter(String szPrinterName)
        {
            ...
            int[] command = { 27, 64 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(command));
        }
        ...
        public bool printText(String szPrinterName, String data)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, byteData);
        ...
        public bool SelectJustification(string szPrinterName, int justification_code)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(align));
        ...
        {
            int[] normal = { 27, 33, 0 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(normal));
        ...
        public bool charFontAText(String szPrinterName)
        {
            ...
            int[] fontA = { 27, 33, 0 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(fontA));
        ...
        {
            int[] fontB = { 27, 33, 1 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(fontB));
        ...
        {
            int[] mode = { 27, 33, 8 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(mode));
            return true;
        }
        ...
        {
            int[] height = { 27, 33, 16 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(height));
        ...
        {
            int[] width = { 27, 33, 32 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(width));
            return true;
        }
        ...
        public bool UnderlineModeText(string szPrinterName)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(underline));
            return true;
        }
        ...
        public bool lineFeed(String szPrinterName, int numLines)
        {
            ...
            {
                ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(lf));
            }
            return true;
        }
        ...
        public bool drawerKick(String szPrinterName)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(pulse));
        ...
        public bool testPrint(String szPrinterName)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(test));
        ...
        public bool charSet(String szPrinterName, int language)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(char_set));
        ...
        public bool codeTable(String szPrinterName, int language)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(code));
        ...
        public bool CutPaper(String szPrinterName)
        {
            ...
            int[] cut = { 29, 86, 0 };
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(cut));
        ...
        public bool buzzer(String szPrinterName)
        {
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(buzzer));
            // ElginI9.SendASCiiToPrinter(szPrinterName, data);
            return true;
        ...
        { //default 0 
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(hri));
            return true;
        }
        ...
        { //default = 0
            ...
            ElginI9.SendBytesToPrinter(szPrinterName, intTobyte(print_position));
            return true;
